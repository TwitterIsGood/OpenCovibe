...
从 [Releases](https://github.com/TwitterIsGood/OpenCovibe/releases) 下载最新 `.dmg` —— 通用二进制，同时支持 Apple Silicon 和 Intel Mac。
...
欢迎贡献！请通过 [Issue](https://github.com/TwitterIsGood/OpenCovibe/issues) 提交 Bug 报告或功能建议，也欢迎提交 Pull Request。
